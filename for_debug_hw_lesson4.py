...
item_1_total_cost = Decimal(item_1_quantity) * Decimal(item_1_price).quantize(Decimal('1.00'))
item_1_total_cost_right_format = item_1_total_cost.quantize(Decimal('1.00'))

item_2_total_cost = Decimal(item_2_quantity) * Decimal(item_2_price).quantize(Decimal('1.00'))
